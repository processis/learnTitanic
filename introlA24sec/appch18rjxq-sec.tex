...
\hypertarget{ux9700ux6c42ux5e76ux4e0dux662fux5173ux4e8eux9700ux6c42-requirements-are-not-really-about-requirements}{%
\subsection{需求并不是关于需求 (Requirements are not really about
requirements)}\label{ux9700ux6c42ux5e76ux4e0dux662fux5173ux4e8eux9700ux6c42-requirements-are-not-really-about-requirements}}
...
使用下面的模型，可以有效地按以下顺序系统地分析与设计业务用例（Business
Use Case BUC) 、产品用例 (Product Use Case PUC)。
...
%\href{文件:当前未来.jpg}{550px}\\

\includegraphics[width=10cm]{当前未来.jpg}
...
%\href{文件:RDM1.3_s15.jpg}{550px}

\includegraphics[width=10cm]{RDM13_s15.jpg}
...
%\href{文件:需求p2.1.jpg}{500px}

\includegraphics[width=10cm]{需求p21.jpg}
...
\subsubsection{用例与场景}\label{ux7528ux4f8bux4e0eux573aux666f}}

用户故事针对``做什么''与``为什么''（``What''，``Why''）；
场景针对``如何做''（``How''），例如普通市民用手机程序搜索下周一央视7台有什么节目。所以它们之间是互补，没有冲突。每个需求都应考虑各类场景，以银行个人用户用银行卡去ATM机取款为例：\\
\textbf{正常情况}：使用个人银行卡取300元\\
\textbf{其他可选情况}：从其他银行卡取款\\
\textbf{异常情况}：取款后没有及时取回银行卡，导致吞卡
...
\subsection{非功能性需求}\label{ux975eux529fux80fdux6027ux9700ux6c42}}
...
\item
  ...
  \tightlist
  \item
    产品的外观和感觉越来越受重视，例子：苹果iPAD MacBook
    等都让客户觉得产品设计精简但高贵
  \end{itemize}
\item
...
\hypertarget{ux5176ux4ed6ux6700ux4f73ux5b9eux8df5}{%
\section{其他最佳实践}\label{ux5176ux4ed6ux6700ux4f73ux5b9eux8df5}}
...
%\href{文件:19_满意度.jpg}{450px}

\includegraphics[width=10cm]{19_满意度.jpg}

%\href{文件:19_不满意度.jpg}{450px}

\includegraphics[width=10cm]{19_不满意度.jpg}
...
\tightlist
\item[]
（用实体卡片,团队难以互动、分享，有些公司采用系统
记录与跟踪需求。电子卡也应包括以上内容。）
\end{description}

\hypertarget{ux505aux597dux9700ux6c42ux8bc4ux5ba1}{%
\subsection{做好需求评审}\label{ux505aux597dux9700ux6c42ux8bc4ux5ba1}}
...
\hypertarget{ux5b9eux4f8bux89e3ux8bfbexamples-explanation}{%
\subsubsection{\texorpdfstring{\textbf{实例/解读(Examples /
Explanation)}}{实例/解读(Examples / Explanation)}}\label{ux5b9eux4f8bux89e3ux8bfbexamples-explanation}}
...
在开发消费产品、大市场软件时，应该考虑用一个\textbf{``假想用户''}。假想用户是一个虚拟用户，它是大多数用户的原型。\\
类型/分组的例子如下：\\
\textbf{未来笔记本电脑的潜在用户}：\\
大类：\\
\#商业人士 (Business)
...
%\href{文件:296页替换图片.jpg}{500px}

\includegraphics[width=10cm]{296页替换图片.jpg}
...
%\href{文件:19_满意程度.jpg}{600px}

\includegraphics[width=10cm]{19_满意程度.jpg}
...
\hypertarget{ux7ebfux4e0aux7eedux62a4ux7167ux7684-ux5f02ux5e38ux573aux666f}{%
\subsection{线上续护照的
异常场景}\label{ux7ebfux4e0aux7eedux62a4ux7167ux7684-ux5f02ux5e38ux573aux666f}}
...
\tightlist
\item
  Beck, Kent , with D. West. "User Stories in Agile Software
  Development" , Ch.13 of \emph{Scenarios, Stories, Use Cases: Through
  the Systems Development Life-Cycle} edited by F. Alexander(2004)\\
\item
