\chapter{附录A:绅士俱乐部过程改进} % Introduction chapter suppressed from the table of contents

\hypertarget{ux539fux56e0ux5206ux6790ux4e0eux89e3ux51b3}{%
\subsection{原因分析与解决}\label{ux539fux56e0ux5206ux6790ux4e0eux89e3ux51b3}}

如果不想问题重现，便要分析背后的根本原因，并采取对应纠正措施。

\textbf{实例}\\
80年代，美国学者Dr
Wheeler到日本做培训，晚上好客的日本人请他去绅士俱乐部(Esquire)。他发现年轻的女服务员腰上都有一个英文Q字牌子，便好奇地问原因。原来这家俱乐部刚完成几个月的过程改进，得到政府奖励金，所以都挂上这个Q牌（Q代表Quality质量）。

Dr Wheeler
把这家俱乐部的过程改进故事总结成书（见参考），以下是重点内容：
...
从10月份到次年2月份，啤酒和清酒的平均每月损失约49，000 日元。
...
\href{文件:club11111.jpg}{600px}

\textbf{鱼骨图每个分支的主要内容如下:}

\href{文件:418页替换图片.jpg}{600px}

\href{文件:club13.1.1.jpg}{600px}

\href{文件:419页替换图片.jpg}{600px}

\href{文件:420页替换图片.jpg}{600px}
...
\item
  制订规程来分配各个区域的工作。每个小时每个区域负责人必须检查一次所有范围内的票据。
\item
...
\hypertarget{ux5bf9ux5e94-cmmiux5b9eux8df5}{%
\subsubsection{对应 CMMI实践}\label{ux5bf9ux5e94-cmmiux5b9eux8df5}}
...
\item
  对应7条主因，制定纠正措施
\item
  收集改进后3至5月份数据，与之前10至2月份比较，发现啤酒、清酒的损失量与总金额都有显著改善
\item
  汇总成A3 报告 （A3 纸 是A4 的一倍，含4面A4。）
\end{itemize}
