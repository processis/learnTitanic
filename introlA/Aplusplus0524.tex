...
\part{做好迭代回顾降低质量成本 }
怎样可以避免同类问题重复发生？ 因为很多问题背后原因都是整个系统的不足， 而不仅仅是个人不关注/不努力，根因分析做好可以帮我们找出背后的根因。\\

怎样可以做好根因分析？二八原则，五个”为什么”等，大家都可能听过。 在网上也可能找到相关理论知识。但很多人还是有误解,没有弄清楚应怎么利用那些技巧找出原因。\\

针对软件开发有效过程改进，也可以使用根因分，帮软件团队避免问题重复发生， 提升团队的质量和效率。\\

迭代回顾(Retrospective)可以让团队每走一小步（冲刺），便立马回顾有那些不足，分析根因，以便在下一小步中改善。\\

要做好迭代回顾，除了要了解根因分析技巧，也要了解回顾背后的原则，配合互动团队练习，再配合工具分析数据， 才能使团队有实际的提升，让老板满意。 \\
