...
\includegraphics[width=10cm]{CompareAB1Screenshot_2022-11-06_2119471.jpg}

想比较A、B两组实验结果是否有显著差异。如果像上图，应该看到B明显比A高。\\
但如果像下图，就很难看得出来：\\
%\href{文件:CompareAB2Screenshot_2022-11-06_212036.1.jpg}{600px}

\includegraphics[width=10cm]{CompareAB2Screenshot_2022-11-06_2120361.jpg}
...
\includegraphics[width=10cm]{1sigmaUnknownHistogram_of_strength-1.jpg}
...
\includegraphics[width=10cm]{TypeOneTwoErrorScreenshot_2022-07-23_151744-1.jpg}
...
一名研究人员假设大学为男生提供的运动项目的平均数量大于大学为女生提供的运动项目的平均数量。下表是对大学男女生提供的体育项目数量的随机抽样结果（各50位大学男女生数据分成两组，两组数据之间没有对应关系），设定临界概率为5\%
（Alpha α=0.05），是否有足够的证据支持这种说法? （假设方差都一样，
\(\sigma\) = 3.3）。

%Screenshotfrom2023-11-1003-40-34.png

%\includegraphics[width=10cm]{Screenshotfrom2023-11-1003-40-34.png}
...
\hline
\multicolumn{5}{|c|}{男生 Males}&\multicolumn{5}{|c|}{女生 Females }\\
\hline
...
%\includegraphics[width=10cm]{Screenshotfrom2023-11-2801-58-19.png}
...
\includegraphics[width=10cm]{5anovaBoxplot_of_small_sedans_luxury-1.jpg}
...
%\includegraphics[width=10cm]{Screenshotfrom2023-11-2801-58-54.png}
...
\includegraphics[width=10cm]{AnovaBoxplots807-1.jpg}

%\href{文件:Anova3inOneScreenshot_2022-08-07_125131.jpg}{400px}

\includegraphics[width=10cm]{Anova3inOneScreenshot_2022-08-07_125131-1.jpg}
...
\includegraphics[width=10cm]{6chiSquareTstResultScreenshot_2022-07-24_103606-1.jpg}
...
%\includegraphics[width=10cm]{Screenshotfrom2023-11-1003-46-42.png}
