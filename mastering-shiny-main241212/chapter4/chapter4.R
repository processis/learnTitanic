...
download("/media/user/娱乐/mastering-shiny-main/chapter4/injuries.tsv.gz")

download("/media/user/娱乐/mastering-shiny-main/chapter4/population.tsv")
download("/media/user/娱乐/mastering-shiny-main/chapter4/products.tsv")
