...
# 12. 保存结果到数据表
results <- tibble(
  Model = c("Linear Regression", "Random Forest","SVM", "Neural Network","Ridge Regression", "Elastic Net","KKNN"),
  RMSE = c(lm_rmse, rf_rmse,svm_rmse, nnet_rmse,ridge_rmse, enet_rmse,KKNN_rmse),
  Rsquared = c(lm_rsq, rf_rsq,svm_rsq, nnet_rsq,ridge_rsq, enet_rsq,KKNN_rsq)
)
