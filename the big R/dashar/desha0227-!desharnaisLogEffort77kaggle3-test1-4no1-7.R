...
desharnais <- read.table("/media/user/娱乐/learnTitanic/the big R/dashar/desharnaisLogEffort77kaggleLang3no1-7.csv",
                         sep = ",", header = TRUE)
...
#56,41,22,73,32,13,66
library(dplyr)

deshaTest <-desha%>%filter(Project%in%c(56,41,22,73,32,13,66))


#deshaTest <- subset(desha,Project < 9)

#choose TeamExp ManagerExp  LogLength  LogEffort LOgptsAjust
deshaTrain = deshaTrain[,c(2:3,15,16,17)]

deshaTest = deshaTest[,c(2:3,15,16,17)]
