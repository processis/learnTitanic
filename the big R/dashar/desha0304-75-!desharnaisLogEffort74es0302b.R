...
#cleanFinalDesharnaisLogEffort75.csv

desharnais <- read.table("/media/user/娱乐/learnTitanic/the big R/dashar/cleanFinalDesharnaisLogEffort75.csv",
                         sep = ",", header = TRUE)
...
deshaTrain = deshaTrain[,c(2:3,15,16)]

deshaTest = deshaTest[,c(2:3,15,16)]
...
deshaTrainX = deshaTrain[,c(1,2,4)]
deshaTestX = deshaTest[,c(1,2,4)]
