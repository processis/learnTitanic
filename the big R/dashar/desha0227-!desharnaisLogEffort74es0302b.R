...
desharnais <- read.table("cleanDesharnaisLogEffort74.csv",
                         sep = ",", header = TRUE)
...
data <- read.csv("cleanDesharnaisLogEffort74.csv")
...
deshaTest <- subset(desha,Project = 1)
deshaTrain <- subset(deshaTrain,Project!=18)
deshaTest <- subset(desha,Project = 18)
deshaTrain <- subset(deshaTrain,Project!=21)
deshaTest <- subset(desha,Project = 21)
deshaTrain <- subset(deshaTrain,Project!=51)
deshaTest <- subset(desha,Project = 51)
deshaTrain <- subset(deshaTrain,Project!=54)
deshaTest <- subset(desha,Project = 54)
deshaTrain <- subset(deshaTrain,Project!=58)
deshaTest <- subset(desha,Project = 58)
deshaTrain <- subset(deshaTrain,Project!=59)
deshaTest <- subset(desha,Project = 59)
deshaTrain <- subset(deshaTrain,Project!=65)
deshaTest <- subset(desha,Project = 65)
deshaTrain <- subset(deshaTrain,Project!=69)
deshaTest <- subset(desha,Project = 69)
deshaTrain <- subset(deshaTrain,Project!=70)
deshaTest <- subset(desha,Project = 70)
deshaTrain <- subset(deshaTrain,Project!=80)
deshaTest <- subset(desha,Project = 80)
deshaTrain <- subset(deshaTrain,Project!=81)
deshaTest <- subset(desha,Project = 81)
...
deshaTrainX = deshaTrain[,c(1,3)]
deshaTestX = deshaTest[,c(1,3)]
